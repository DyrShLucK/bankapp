...
public class CashServiceGet {
    ...
    public Mono<AccountCashResponse> cashFunc(Mono<CashTransfer> cashTransfer, String username,  String userName) {
        return cashServicePost.getAccountserviceResponceCash(cashTransfer, username, userName);
    }
}
